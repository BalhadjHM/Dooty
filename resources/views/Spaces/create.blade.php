<x-layouts.app>
    ...
    <x-slot name="content">
        ...
        <div class="w-4/5 md:w-1/2 my-10 mx-auto py-4 md:py-6 px-4 md:px-8 bg-background rounded-md shadow-sm">
            <div class="xl:h-96 flex flex-col xl:flex-row items-center xl:space-x-12">
                ...
                <div class="py-2 w-full xl:basis-2/3 space-y-4">
                    ...
                    <form action="" method="POST" class="space-y-2 md:space-y-2">
                        @csrf
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <textarea name="description" id="description" class="py-2 px-2 bg-background text-text open-sans-medium text-sm rounded-md border-text focus:border-accent focus:ring-1 focus:ring-accent">{{ old('description') }}</textarea>
                        </div>
                        <div class="flex flex-col gap-1">
                            <label for="tags" class="open-sans-medium text-text text-sm">Tags</label>
                            <input type="text" name="tags" id="password" class="py-2 px-2 bg-background text-text open-sans-medium text-sm rounded-md border-text focus:border-accent focus:ring-1 focus:ring-accent">
                        </div>
                        <div class="flex flex-col gap-1">
