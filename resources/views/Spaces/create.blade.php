                ...
                <div class="py-2 w-full xl:basis-2/3 space-y-4">
                    ...
                    <form action="" method="POST" class="space-y-2 md:space-y-2">
                        ...
                        <div>
                            ...
                            <a href="{{ route('user.login') }}" class="block sm:inline mt-4 sm:mt-0 sm:ml-8 text-center sm:text-start open-sans-medium text-xs text-primary hover:underline underline-offset-2">Return to dashboard</a>
                        </div>
                    </form>
                </div>
            </div>
